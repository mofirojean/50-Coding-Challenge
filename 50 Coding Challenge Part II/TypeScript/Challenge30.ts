...
// Test Cases
let first: string = "893427328497983427893248932498034289324";
let second: string = "234859234879342897893427893274";

function findSum(first: string, second: string): string{
    let sum: string = "";
    let carry: number = 0;
    let diff: number = second.length - first.length;
